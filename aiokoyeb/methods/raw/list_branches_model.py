...
from aiokoyeb.models import Error, ErrorWithFields, GooglerpcStatus, KgitproxyListBranchesReply
...
class ListBranchesModel(
    ...
    @property
    def uri(self) -> str:
        return self._url_for("/v1/git/branches")
    ...
    def query_params(self) -> dict:
        ...
        if self.repository_id is not None:
            __query_params__["repository_id"] = self.repository_id
